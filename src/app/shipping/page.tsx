    ...
    return (
        <div className="bg-background text-foreground min-h-screen p-4 sm:p-8 flex flex-col items-center">
            ...
            <div className="bg-card rounded-2xl p-8 sm:p-12 w-full max-w-4xl space-y-8 border">
                <div>
                    <h1 className="text-3xl font-bold mb-4 text-foreground">Shipping Policy</h1>
                </div>

                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">1. Delivery Timelines</h2>
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">2. Delivery Attempts & Reattempts</h2>
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <div className="space-y-4">
                    <h2 className="text-2xl font-bold text-foreground">3. Delayed Deliveries</h2>
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
